            ...
            <CardContent className="flex-1 overflow-auto p-0 scrollbar-thin scrollbar-thumb-gray-200">
                {transactions.length === 0 ? (
                    <div className="flex flex-col items-center justify-center h-64 text-center p-8">
                        ...
                        <h3 className="text-base font-medium text-slate-900">No Recent Transactions</h3>
                        <p className="mt-1 text-sm text-slate-500 max-w-xs">Start tracking your business by recording your first sale or expense.</p>
                        <button className="mt-4 inline-flex items-center px-4 py-2 bg-emerald-600 text-white rounded-lg text-sm font-medium hover:bg-emerald-700 transition-colors shadow-sm">
                            + Record Transaction
                        </button>
                    </div>
                ) : (
                            ...
                            >
                                <div className="flex items-center space-x-4">
                                    <div className={cn(
                                        ...
                                        tx.type === 'income' ? "bg-emerald-100 text-emerald-700" : "bg-slate-100 text-slate-400"
                                    )}>
                                ...
                                <div className="flex items-center space-x-3">
                                    ...
                                    <button
                                        ...
                                        className="opacity-0 group-hover:opacity-100 transition-opacity duration-200 p-1.5 rounded-lg hover:bg-emerald-50 text-emerald-500 hover:text-emerald-600 disabled:opacity-50 disabled:cursor-not-allowed"
