        ...
        return (
            <div className="flex items-center justify-center h-96">
                <div className="text-center">
                    ...
                    <p className="text-emerald-300">Loading settings...</p>
                </div>
            </div>
        );
    }
    ...
    if (!isSuperAdmin) {
        return (
            <div className="text-center py-16">
                <Settings className="w-16 h-16 text-emerald-500/30 mx-auto mb-4" />
                <h3 className="text-xl font-semibold text-white mb-2">Access Restricted</h3>
                <p className="text-emerald-400">Only super administrators can modify platform settings</p>
            </div>
        );
    }
        ...
        <div className="space-y-6">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <div>
                    ...
                    <p className="text-emerald-300 mt-1">Configure your Trackify platform</p>
                </div>
                <div className="flex gap-2">
                    ...
                    <button
                        ...
                        className="p-2 rounded-xl text-emerald-300 hover:bg-emerald-500/20 transition-all"
                    ...
                    <div className="grid gap-6 md:grid-cols-2">
                        <div>
                            ...
                            <input
                                ...
                                className="w-full px-4 py-3 rounded-xl text-white focus:outline-none focus:ring-2 focus:ring-emerald-500"
                                style={{
                                    background: 'rgba(255, 255, 255, 0.05)',
                ...
                <div className="p-6 rounded-2xl" style={{
                    ...
                    <div className="grid gap-6 md:grid-cols-2">
                        <div>
                            ...
                            />
                            <p className="mt-1 text-xs text-emerald-400">Number of businesses a user can create</p>
                        </div>
                        <div>
                            <label className="block text-sm font-medium text-emerald-200 mb-2">
                                Default Currency
                ...
                <div className="p-6 rounded-2xl" style={{
                    ...
                    <div className="grid gap-6 md:grid-cols-2">
                        <div>
                            ...
                            />
                            <p className="mt-1 text-xs text-emerald-400">e.g., INV-001, BILL-001</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="p-6 rounded-2xl" style={{
                    ...
                    <div className="space-y-4">
                        <div className="flex items-center justify-between p-4 rounded-xl" style={{
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-emerald-400">Send platform notifications to users</p>
                                </div>
                            </div>
                        ...
                        <div className="flex items-center justify-between p-4 rounded-xl" style={{
                            ...
                            <div className="flex items-center gap-3">
                                <Wrench className={`w-5 h-5 ${settings.maintenance_mode === true || settings.maintenance_mode === 'true' ? 'text-red-400' : 'text-emerald-400'}`} />
                                <div>
                                    <p className="text-white font-medium">Maintenance Mode</p>
                                    <p className="text-sm text-emerald-400">Temporarily disable access for non-admins</p>
                                </div>
                            </div>
                            <label className="relative inline-flex items-center cursor-pointer">
                                <input
